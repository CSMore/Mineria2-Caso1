...
class ModelEvaluator:
    ...
    def __init__(self, X_train, X_test, y_train, y_test, population_size, generations, mutation_rate):
    ...
    def genetic_search(self):
        ...
        for name, model in self.models.items():
            ...
            evolved_estimator = GASearchCV(
                ...
                population_size=self.population_size,  # Usa el parámetro recibido
                generations=self.generations,          # Usa el parámetro recibido
                tournament_size=3,
                elitism=True,
                crossover_probability=0.8,
                mutation_probability=self.mutation_rate,  # Usa el parámetro recibido
